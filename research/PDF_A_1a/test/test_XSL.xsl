...
&lt;!DOCTYPE fo:root [
  ...
  <xsl:template match="h1">
    ...
    <fo:block font-size="2em" font-weight="700" space-before="0.67em" space-after="0.67em" line-height="32pt"
      keep-with-next="always">
  ...
  <xsl:template match="h2">
    <fo:block font-size="2em" font-weight="700" space-before="1.5em" space-after="1.5em" line-height="28pt"
      keep-with-next="always">
      <xsl:attribute name="id">
        <xsl:choose>
          <xsl:when test="@id">
